...
export default function Example() {
  ...
  return (
    <div className="bg-white text-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8" style={{ backgroundImage: `url(${backgroundImage1})`, backgroundSize: 'cover', backgroundPosition: 'center',backgroundRepeat: 'no-repeat'
  }}>
        <div
